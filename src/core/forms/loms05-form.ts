...
export class LOMS05Form extends AbstractForm<LOMS05Page> {
  readonly formType = 'LOMS05' as const;
  readonly name = 'Meldebescheinigung zur Sozialversicherung';
  ...
  extractMetadata(text: string, pageIndex: number, rawText: string): LOMS05Page {
    return {
  ...
  hasPersonnelNumbers(): boolean {
    return true;  // LOMS05 has personnel numbers
  }

  // ============================================================================
  // Private Extraction Methods (Minimal)
  // ============================================================================
